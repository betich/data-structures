...
public class Main {
	...
	public static boolean addDepartment(String newName) {
		...
		//TODO: If newName duplicates with an existing department, then throw DuplicateGuildNameException 
		//to warn the user that the department name cannot be duplicate and return false.
		
		//HINT: createDepartment from GuildDatabase returns a boolean
		//for a good reason.
		
		//HINT2: use try/catch so that the program can continue running when an exception is thrown.
		//Don't put throws DuplicateGuildNameException in the method name or the program will break!
	...
	public static void removeDepartmentFromDatabase(int index) {
		...
		//TODO: Put all the members from the removed department in the "Unassigned" department.
